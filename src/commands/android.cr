module Hokusai::Native::Commands
  @[ACONA::AsCommand("android", description: "Generates and packages the native image for a Hokusai-Native project")]
  class Android < ACON::Command
    protected def execute(input : ACON::Input::Interface, output : ACON::Output::Interface) : ACON::Command::Status
      ...
      begin
        Hokusai::Native::Builder.new(config).build(workers: 1, filter: ["android"])
      rescue ex
